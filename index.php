...
<html lang="en">
  <head>
    ...
    <title>Micaela Mingrone | Portfolio </title>
    <!--CDN FONTAWESOME-->
  ...
  <body>
   <header class="header">
        <!--NAVBAR-->
        <nav class="navbar navbar-expand-md navbar-fixed-top mt-2 sticky-sm-top">
...
<section class="wrapper">
    <div class="container">
             ...
             <div class="row">  
                 ...
                 <div class="col-sm-12 d-flex justify-content-center text-center">
                     <p class="subtitle">Soy Micaela Mingrone</p>
                 </div>
                 
                 <div class="col-sm-12 d-flex justify-content-center text-center">
                     <p class="subtitle">Fullstack web developer</p>
                 </div>
...
<!-- CONTAINER-->
        ...
        <div class="row people d-flex justify-content-center" id="scroll-cards">
                <div class="col-md-4 col-lg-3 item">
                    ...
                    <form class="d-flex justify-content-center">
                        <a class="btn btn-styled btn-sm btn mb-3" href="https://github.com/micamingrone/crudphpcac22">Ver +</a>
                    </form>
                </div>
                <div class="col-md-4 col-lg-3 item">
                    ...
                    <form class="d-flex justify-content-center">
                        <a class="btn btn-styled btn-sm btn mb-3" href="https://micamingrone.github.io/">Ver +</a>
                    </form>
                </div>
                <div class="col-md-4 col-lg-3 item">
                    ...
                    <form class="d-flex justify-content-center">
                        <a class="btn btn-styled btn-sm btn mb-3" href="https://github.com/micamingrone/AppConsola/tree/master">Ver +</a>
                    </form>
                </div>
            ...
            <div class="row people d-flex justify-content-center">
                ...
                <div class="col-md-4 col-lg-3 item">
                    ...
                    <form class="d-flex justify-content-center">
                        <a class="btn btn-styled btn-sm btn mb-3" href="https://weather-app-js-xi.vercel.app/">Ver +</a>
                    </form>
                </div>
                <div class="col-md-4 col-lg-3 item">
                    ...
                    <form class="d-flex justify-content-center">
                        <a class="btn btn-styled btn-sm btn mb-3" href="https://github.com/micamingrone/appClima">Ver +</a>
                    </form>
                </div>
    ...
    <footer class="footer">
        <div class="container">
            <div class="row justify-content-center">
                <p class="text-center pt-4">&copy;{Hecho con ❤ por Mica Mingrone/} </p>
            </div>
            <div class="row justify-content-center">
